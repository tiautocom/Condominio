<%@ Page Title="Avisos e Comunicações" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AvisoComunicado.aspx.cs" Inherits="TI.CONDOMINIO.TRANSPARENCIA.UI.Cadastro.AvisoComunicado" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Avisos e Comunicações</h2>
    ...
    <%--    <h4>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                 <asp:Label runat="server" AssociatedControlID="txtDesc">Titulo:</asp:Label>
                <asp:TextBox runat="server" ID="txtDesc" CssClass="form-control" TextMode="Search" Width="100%" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDesc" CssClass="text-danger" ErrorMessage="Campo Obrigatório." />
            </div>
